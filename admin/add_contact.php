...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $github         = mysqli_real_escape_string($conn, $_POST['github'] ?? null);
    $devto          = mysqli_real_escape_string($conn, $_POST['devto'] ?? null);
    $hashnode       = mysqli_real_escape_string($conn, $_POST['hashnode'] ?? null);
    $discord        = mysqli_real_escape_string($conn, $_POST['discord'] ?? null);
    $producthunt    = mysqli_real_escape_string($conn, $_POST['producthunt'] ?? null);
    $google_review  = mysqli_real_escape_string($conn, $_POST['google_review'] ?? null);
    ...
    if ($check && $check->num_rows > 0) {
        ...
        $stmt = $conn->prepare("INSERT INTO contacts
            (address, address2, phone, wp_number, telephone, email, working_hours, facebook, instagram, twitter, linkdin, github, devto, hashnode, discord, producthunt, google_review, map, contact_email)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
                                    ...
                                    <form action="" method="post">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <div class="input-with-icon">
                                                <i class="fab fa-github social-icon text-dark"></i>
                                                    <input type="url" class="form-control" name="github"
                                                           placeholder="https://github.com/yourusername"
                                                           value="<?php echo htmlspecialchars($data['github'] ?? ''); ?>">
                                                </div>
                                            </div>

                                            <div class="col-md-4 mb-3">
                                                <label for="devto" class="form-label">Dev.to</label>
                                                <div class="input-with-icon">
                                                <i class="fab fa-dev social-icon text-dark"></i>
                                                    <input type="url" class="form-control" name="devto"
                                                           placeholder="https://dev.to/yourusername"
                                                           value="<?php echo htmlspecialchars($data['devto'] ?? ''); ?>">
                                                </div>
                                            </div>

                                            <div class="col-md-4 mb-3">
                                                <label for="hashnode" class="form-label">Hashnode</label>
                                                <div class="input-with-icon">
                                                <i class="fas fa-hashtag social-icon text-primary"></i>
                                                    <input type="url" class="form-control" name="hashnode"
                                                           placeholder="https://hashnode.com/@yourusername"
                                                           value="<?php echo htmlspecialchars($data['hashnode'] ?? ''); ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <div class="input-with-icon">
                                                <i class="fab fa-discord social-icon text-primary"></i>
                                                    <input type="url" class="form-control" name="discord"
                                                           placeholder="https://discord.gg/yourinvite"
                                                           value="<?php echo htmlspecialchars($data['discord'] ?? ''); ?>">
                                                </div>
                                            </div>

                                            <div class="col-md-4 mb-3">
                                                <label for="producthunt" class="form-label">Product Hunt</label>
                                                <div class="input-with-icon">
                                                <i class="fab fa-product-hunt social-icon text-danger"></i>
                                                    <input type="url" class="form-control" name="producthunt"
                                                           placeholder="https://www.producthunt.com/@yourusername"
                                                           value="<?php echo htmlspecialchars($data['producthunt'] ?? ''); ?>">
                                                </div>
                                            </div>

                                            <div class="col-md-4 mb-3">
                                                <label for="google_review" class="form-label">Google Review Link</label>
                                                <div class="input-with-icon">
                                                <i class="fab fa-google social-icon text-danger"></i>
                                                    <input type="url" class="form-control" name="google_review"
                                                           placeholder="https://g.page/r/xxxxx/review"
                                                           value="<?php echo htmlspecialchars($data['google_review'] ?? ''); ?>">
                                                </div>
                                            </div>
                                        </div>
