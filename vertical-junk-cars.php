    ...
    <div class="row align-items-center g-5">
      <div class="col-lg-6">
        <div style="border-radius:20px;overflow:hidden;box-shadow:0 20px 40px rgba(0,0,0,0.12);">
          <img src="<?= $site ?>assets/img/all-images/case-img1.png" alt="Junk car buyer website design for <?= htmlspecialchars($c['country_name']) ?>" style="width:100%;display:block;">
        </div>
      </div>
      <div class="col-lg-6">
      ...
      <div class="col-lg-9">
        <div class="accordion" id="junkCarFaq">
          <div class="accordion-item">
            <h3 class="accordion-header"><button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#jc1">Can the quote form calculate an actual price estimate?</button></h3>
            <div id="jc1" class="accordion-collapse collapse show" data-bs-parent="#junkCarFaq">
              <div class="accordion-body">We can build a form that gives an estimated price range based on year, make, model and condition, or route submissions straight to your team for a manual quote — whichever fits how your business actually prices vehicles.</div>
            </div>
          </div>
          <div class="accordion-item">
            <h3 class="accordion-header"><button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#jc2">Do you build separate pages for each city we serve?</button></h3>
            <div id="jc2" class="accordion-collapse collapse" data-bs-parent="#junkCarFaq">
              <div class="accordion-body">Yes — dedicated service-area pages per city or region are one of the highest-impact things for this business type, since most searches are "junk car buyer [city]" rather than generic terms.</div>
            </div>
          </div>
          <div class="accordion-item">
            <h3 class="accordion-header"><button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#jc3">How fast can this launch?</button></h3>
            <div id="jc3" class="accordion-collapse collapse" data-bs-parent="#junkCarFaq">
              <div class="accordion-body">A single-location junk car buyer site with a quote form typically launches in 1-2 weeks. Multi-city service-area builds take a bit longer depending on how many locations you need pages for.</div>
            </div>
          </div>
          <div class="accordion-item">
            <h3 class="accordion-header"><button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#jc4">Can you also handle ongoing updates after launch?</button></h3>
            <div id="jc4" class="accordion-collapse collapse" data-bs-parent="#junkCarFaq">
          ...
          <div class="accordion-item">
            <h3 class="accordion-header"><button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#jc5">What does this typically cost?</button></h3>
            <div id="jc5" class="accordion-collapse collapse" data-bs-parent="#junkCarFaq">
              <div class="accordion-body">For <?= htmlspecialchars($c['country_name']) ?>, typical projects range <?= htmlspecialchars($c['price_range']) ?>, depending on how many service-area pages and integrations (like VIN lookup) you need. You'll get a fixed-scope quote before any work starts.</div>
            </div>
          </div>
        </div>
      </div>
