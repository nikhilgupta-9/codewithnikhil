...
// Fix 1 — Canonical variable define karo page ke top pe
$canonical = $site . "blogs/";

// Agar tag filter hai to noindex
...
<head>
  ...
  <!-- Canonical — always /blogs/ pe point karo -->
  ...
  <!-- Schema — BreadcrumbList (Fix: no double slash) -->
        ...
        ?>
          <div class="col-lg-4 col-md-6">
            <div class="blog-author-boxarea">
              <div class="img1">
                <img src="<?= $site ?>admin/uploads/blogs/<?= $blog['image'] ?>" alt="<?= htmlspecialchars($blog['title']) ?>" loading="lazy">
              </div>
