...
<head>
  ...
  <!-- ✅ FIX: Dynamic title — short, clean, consistent brand -->
  <title><?= htmlspecialchars($product_details['meta_title']) ?> | NikhilWorks</title>

  <!-- ✅ FIX: Dynamic meta tags -->
  <meta name="description" content="<?= htmlspecialchars($product_details['meta_desc']) ?>">
  <meta name="keywords" content="<?= htmlspecialchars($product_details['meta_key']) ?>">
  ...
  <!-- ✅ FIX: Canonical URL uses $cat_slug (NOT $service['slug'] which was undefined) -->
  ...
  <!-- ✅ FIX: Open Graph — fully dynamic, no hardcoded values -->
  <meta property="og:title" content="<?= htmlspecialchars($product_details['meta_title']) ?> | NikhilWorks">
  ...
  <!-- ✅ FIX: Twitter Card — dynamic -->
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="<?= htmlspecialchars($product_details['meta_title']) ?> | NikhilWorks">
  ...
  <!-- ✅ Schema: ProfessionalService + specific Service for this page -->
  <script type="application/ld+json">
  {
    "@context": "https://schema.org",
    "@type": "Service",
...
<body class="homepage4-body">
    ...
    <div class="container">
      <div class="row">
        <div class="about-inner-header heading9 text-center">
          <h1><?= htmlspecialchars($product_details['pro_name']) ?></h1>
          <p class="text-dark mt-3">
            <?= htmlspecialchars($product_details['meta_desc']) ?>
          </p>
  ...
  <section class="container py-5">
    <div class="row align-items-center g-5">
      ...
      <div class="col-lg-6">
        <h2 class="h1 mb-3"><?= htmlspecialchars($product_details['pro_name']) ?></h2>
        <div class="mb-3"><?= $product_details['short_desc'] ?></div>
      ...
      <div class="row g-4">
        <div class="col-md-4">
          <div class="service-card text-center p-4 shadow-sm h-100">
            ...
            <p>Clean, fast, and lightweight websites ideal for portfolios, landing pages, and small businesses.</p>
          </div>
        </div>
        <div class="col-md-4">
          <div class="service-card text-center p-4 shadow-sm h-100">
            ...
            <p>PHP / MySQL based websites with admin panels, forms, dashboards, and custom functionality.</p>
          </div>
        </div>
        <div class="col-md-4">
          <div class="service-card text-center p-4 shadow-sm h-100">
            ...
            <p>Advanced applications built using MERN, Laravel, or custom stacks for scalable business needs.</p>
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="accordion accordion-flush" id="accordionFlushExample">
              <div class="accordion-item">
                ...
                <div id="flush-collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionFlushExample">
                  <div class="accordion-body">I build responsive, performance-focused websites using the latest technologies like MERN stack, Laravel, and WordPress—tailored to your business goals.</div>
                  <div class="space10"></div>
                  <div class="accordion-body body2">Whether it's an e-commerce store or a personal portfolio, I ensure scalable code and clean UI/UX.</div>
                </div>
              </div>
              ...
              <div class="accordion-item">
                ...
                <div id="flush-collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                  <div class="accordion-body">I provide regular progress updates, clear timelines, and open communication so you're never left guessing.</div>
                  <div class="space10"></div>
                  <div class="accordion-body body2">From kickoff to launch, every milestone is shared and documented.</div>
                </div>
              </div>
              <div class="space24"></div>
              <div class="accordion-item">
                ...
                <div id="flush-collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                  <div class="accordion-body">My projects consistently improve client visibility, conversions, and performance across devices and search engines.</div>
                  <div class="space10"></div>
                  <div class="accordion-body body2">Real-world results: faster load times, higher SEO rankings, and measurable growth.</div>
                </div>
              </div>
              <div class="space24"></div>
              <div class="accordion-item">
                ...
                <div id="flush-collapseFour" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                  <div class="accordion-body">From concept and design to deployment and maintenance, I provide full support for smooth project delivery.</div>
                  <div class="space10"></div>
                  <div class="accordion-body body2">Need updates or new features later? I'm here for long-term collaboration.</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="row">
        <div class="col-lg-4 m-auto">
          <div class="pricing-header heading8 text-center">
            <h5 data-aos="fade-up" data-aos-duration="1000"><img src="assets/img/icons/logo-icons6.svg" alt="">Pricing & Plan</h5>
            <h2 class="text-anime-style-1">Transparent <span>Pricing Plans <img src="assets/img/elements/line-img2.png" alt=""></span></h2>
          </div>
        </div>
      </div>
      <div class="row">
          ...
          <div class="accordion d-flex flex-column gap-3" id="serviceFaqAccordion">
            ...
            <div class="accordion-item faq-item">
              ...
              <div id="faq2" class="accordion-collapse collapse" data-bs-parent="#serviceFaqAccordion">
                <div class="accordion-body text-muted">
                  Yes! All plans include post-launch support — <strong>1 month</strong> for static sites, <strong>3 months</strong> for dynamic sites, and <strong>ongoing support</strong> for custom web applications.
                </div>
              </div>
            </div>
            <div class="accordion-item faq-item">
              ...
              <div id="faq3" class="accordion-collapse collapse" data-bs-parent="#serviceFaqAccordion">
                <div class="accordion-body text-muted">
                  Absolutely. Every website I build is <strong>fully responsive</strong> and thoroughly tested across mobile, tablet, and desktop devices.
                </div>
              </div>
            </div>
            <div class="accordion-item faq-item">
              ...
              <div id="faq4" class="accordion-collapse collapse" data-bs-parent="#serviceFaqAccordion">
                <div class="accordion-body text-muted">
                  Yes. Every website I deliver includes <strong>on-page SEO basics</strong> — meta tags, schema markup (JSON-LD), XML sitemap, robots.txt, image optimization, and fast page load speed.
                </div>
              </div>
            </div>
            <div class="accordion-item faq-item">
              ...
              <div id="faq5" class="accordion-collapse collapse" data-bs-parent="#serviceFaqAccordion">
                <div class="accordion-body text-muted">
                  Yes! I work remotely with clients from the <strong>USA, UK, Australia, UAE, Canada,</strong> and beyond. All communication happens via WhatsApp, Zoom, or email.
                </div>
              </div>
            </div>
            <div class="accordion-item faq-item">
              ...
              <div id="faq6" class="accordion-collapse collapse" data-bs-parent="#serviceFaqAccordion">
                <div class="accordion-body text-muted">
                  Business name, project goals, reference websites, logo/brand assets, and content. No worries if you don't have everything — I can help with copywriting and design too.
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="row">
        <div class="col-lg-12 m-auto">
          <div class="testimonial-header heading2 text-center">
            ...
            <p>Don't just take our word for it. Hear what our satisfied clients <br class="d-md-block d-none"> have to say about working with NikhilWorks.</p>
          </div>
        </div>
      </div>
      <div class="row">
          ...
          <div class="testimonials-slider-area owl-carousel">
            <div class="testimonial-boxarea">
              <div class="row">
                <div class="col-lg-5">
                  <div class="pera">
                    <p>"CodeByNikhil built my business website <a href="https://bestok.in/">Bestok</a> and handled everything from design to SEO. Very professional and supportive. Highly recommended!"</p>
                    <div class="space100"></div>
            ...
            <div class="testimonial-boxarea">
              <div class="row">
                <div class="col-lg-5">
                  <div class="pera">
                    <p>"Amazing work! Nikhil developed an e-commerce website for my shop and integrated online payments. Great experience working with him!"</p>
                    <div class="space100"></div>
                    <div class="space30"></div>
                    <div class="list-area">
                      <div class="list">
            ...
            <div class="testimonial-boxarea">
              <div class="row">
                <div class="col-lg-5">
                  <div class="pera">
                    <p>"NikhilWorks made my business visible online. I got more customers after the <a href="https://earnova.co.in/">Earnova</a> website launch. SEO work is also great!"</p>
                    <div class="space100"></div>
                    <div class="space30"></div>
                    <div class="list-area">
                      <div class="list">
                ...
                <div class="col-lg-7">
                  <div class="images">
                    <img src="<?= $site ?>assets/img/all-images/testimonials-img3.jpg" alt="Client Sameer Gaur">
                  </div>
                </div>
              </div>
            </div>
            <div class="testimonial-boxarea">
              <div class="row">
                <div class="col-lg-5">
                  <div class="pera">
                    <p>"Nikhil helped me design a custom Dashboard website <a href="https://marketmindinsight.com/">Market Mind Insight</a> and guided me in digital marketing. Excellent communication and support!"</p>
                    <div class="space100"></div>
                    <div class="space30"></div>
                    <div class="list-area">
                      <div class="list">
                ...
                <div class="col-lg-7">
                  <div class="images">
                    <img src="<?= $site ?>assets/img/all-images/testimonials-img6.jpg" alt="Client Rohit Kumar">
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="row">
        <div class="col-lg-12 m-auto">
          <div class="cta-header-area text-center sp4 heading2">
            <h2 class="text-anime-style-1 text-light">Freelance Web Developer in Delhi NCR – Serving Moti Nagar, Punjabi Bagh & Karampura</h2>
