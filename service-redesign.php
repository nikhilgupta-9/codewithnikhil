    ...
    <div class="row align-items-center g-5">
      <div class="col-lg-6">
        <div style="border-radius:20px;overflow:hidden;box-shadow:0 20px 40px rgba(0,0,0,0.12);">
          <img src="<?= $site ?>assets/img/all-images/case-img1.png" alt="Website redesign for <?= htmlspecialchars($c['country_name']) ?> businesses" style="width:100%;display:block;">
        </div>
      </div>
      <div class="col-lg-6">
      ...
      <div class="col-lg-9">
        <div class="accordion" id="redesignFaq">
          <div class="accordion-item">
            <h3 class="accordion-header"><button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#rd1">Will we lose our Google rankings during the redesign?</button></h3>
            <div id="rd1" class="accordion-collapse collapse show" data-bs-parent="#redesignFaq">
              <div class="accordion-body">Not if it's done correctly. We map every existing URL to its new equivalent with proper 301 redirects and keep the content structure Google already understands, so rankings carry over instead of resetting.</div>
            </div>
          </div>
          <div class="accordion-item">
            <h3 class="accordion-header"><button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#rd2">Can you keep our current content and just redesign the look?</button></h3>
            <div id="rd2" class="accordion-collapse collapse" data-bs-parent="#redesignFaq">
              <div class="accordion-body">Yes — a redesign doesn't have to mean rewriting everything. We can carry over your existing copy, blog posts and media, and focus the work on design, speed and mobile experience.</div>
            </div>
          </div>
          <div class="accordion-item">
            <h3 class="accordion-header"><button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#rd3">How long does a redesign take?</button></h3>
            <div id="rd3" class="accordion-collapse collapse" data-bs-parent="#redesignFaq">
              <div class="accordion-body">Most redesigns take 2-4 weeks depending on site size. Larger sites with e-commerce or many content types can take 4-8 weeks.</div>
            </div>
          </div>
          <div class="accordion-item">
            <h3 class="accordion-header"><button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#rd4">Do you offer ongoing support after the redesign launches?</button></h3>
            <div id="rd4" class="accordion-collapse collapse" data-bs-parent="#redesignFaq">
          ...
          <div class="accordion-item">
            <h3 class="accordion-header"><button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#rd5">What does a redesign typically cost?</button></h3>
            <div id="rd5" class="accordion-collapse collapse" data-bs-parent="#redesignFaq">
              <div class="accordion-body">For <?= htmlspecialchars($c['country_name']) ?>, typical projects range <?= htmlspecialchars($c['price_range']) ?>, depending on site size and whether content migration or e-commerce is involved. You'll get a fixed-scope quote before any work starts.</div>
            </div>
          </div>
        </div>
      </div>
