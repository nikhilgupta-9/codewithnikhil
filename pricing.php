...
<script>
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "itemOffered": {
            ...
            "description": "Easy-to-manage CMS solution"
          },
          "price": "5999",
          "priceCurrency": "INR"
        },
  ...
  <!-- FAQPage Schema — pricing-specific questions -->
  <script type="application/ld+json">
  {
    "@context": "https://schema.org",
    "@type": "FAQPage",
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What's included in each package price?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Every package includes design, development, mobile-responsive layout, and the support period listed on the card. Domain registration and hosting are not included by default, but free guidance is provided on the cheapest reliable options for your region."
        }
      },
      {
        "@type": "Question",
        "name": "Why do the India (INR) and International (USD) prices show different values?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Both are real, independently-set prices, not a currency conversion of each other. The USD pricing reflects standard international market rates while still passing on a meaningful cost advantage of working with an India-based developer."
        }
      },
      {
        "@type": "Question",
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "The website keeps working as-is — the support window covers free bug fixes and minor tweaks. After it ends, ongoing maintenance is available on a pay-as-you-go or monthly retainer basis."
        }
      },
      {
        "@type": "Question",
        "name": "Can I upgrade from a smaller package later?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes. Clients commonly start with a Static or WordPress site and upgrade to a Dynamic or E-Commerce build later, paying only the difference in scope."
        }
      },
      {
        "@type": "Question",
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "International clients can pay via PayPal, Wise, or bank transfer, typically split between an upfront deposit and the remainder due at completion or in milestones for larger builds."
        }
      }
    ]
  }
      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-md-6 mb-4">
          <div class="pricing-boxarea" data-aos="fade-up">
            ...
            <a href="https://wa.me/918368552640?text=Hi! I'm interested in Static Website package (₹3,999)" class="header-btn11">Get Started <span><i class="fa-solid fa-arrow-right"></i></span></a>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 mb-4">
          <div class="pricing-boxarea" data-aos="fade-up">
            ...
            <div class="space24"></div>
            <a href="https://wa.me/918368552640?text=Hi! I'm interested in MERN Stack package (₹13,999)" class="header-btn11">Get Started <span><i class="fa-solid fa-arrow-right"></i></span></a>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-lg-9 m-auto">
          <div class="choose-header-area text-center heading2">
            <h5 data-aos="fade-up" data-aos-duration="1000">FAQ</h5>
            <h2 class="text-anime-style-1">Pricing <span>Questions</span></h2>
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-8 m-auto">
          <div class="accordian-tabs-area">
            <div class="accordion accordion-flush" id="pricingFaqAccordion">

              <!-- FAQ 1 -->
              <div class="accordion-item">
                <h2 class="accordion-header">
                  <button class="accordion-button" type="button" data-bs-toggle="collapse"
                    data-bs-target="#pricingFaqOne" aria-expanded="true" aria-controls="pricingFaqOne">
                    1. What's included in each package price?
                  </button>
                </h2>
                <div id="pricingFaqOne" class="accordion-collapse collapse show" data-bs-parent="#pricingFaqAccordion">
                  <div class="accordion-body">
                    Every package includes design, development, mobile-responsive layout, and the support period listed on the card. Domain registration and hosting are not included by default, but I provide free guidance on the cheapest reliable options for your region.
                  </div>
                </div>
              </div>
              <div class="space24"></div>
              ...
              <div class="accordion-item">
                <h2 class="accordion-header">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    data-bs-target="#pricingFaqTwo" aria-expanded="false" aria-controls="pricingFaqTwo">
                    2. Why do the India (₹) and International ($) prices show different values?
                  </button>
                </h2>
                <div id="pricingFaqTwo" class="accordion-collapse collapse" data-bs-parent="#pricingFaqAccordion">
                  <div class="accordion-body">
                    Both are real, independently-set prices — the USD pricing isn't a currency conversion of the INR price. It reflects standard international market rates while still passing on a meaningful cost advantage of working with a India-based developer.
                  </div>
                </div>
              </div>
              <div class="space24"></div>
              ...
              <div class="accordion-item">
                <h2 class="accordion-header">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    data-bs-target="#pricingFaqThree" aria-expanded="false" aria-controls="pricingFaqThree">
                    3. What happens after my support period ends?
                  </button>
                </h2>
                <div id="pricingFaqThree" class="accordion-collapse collapse" data-bs-parent="#pricingFaqAccordion">
                  <div class="accordion-body">
                    Your website keeps working as-is — the support window just covers free bug fixes and minor tweaks. After it ends, you can request ongoing maintenance on a pay-as-you-go or monthly retainer basis, or handle updates yourself if you're comfortable doing so.
                  </div>
                </div>
              </div>
              <div class="space24"></div>
              ...
              <div class="accordion-item">
                <h2 class="accordion-header">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    data-bs-target="#pricingFaqFour" aria-expanded="false" aria-controls="pricingFaqFour">
                    4. Can I upgrade from a smaller package later?
                  </button>
                </h2>
                <div id="pricingFaqFour" class="accordion-collapse collapse" data-bs-parent="#pricingFaqAccordion">
                  <div class="accordion-body">
                    Yes. Many clients start with a Static or WordPress site and upgrade to a Dynamic or E-Commerce build once their business grows. You only pay the difference in scope, not the full price again.
                  </div>
                </div>
              </div>
              <div class="space24"></div>
              ...
              <div class="accordion-item">
                <h2 class="accordion-header">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    data-bs-target="#pricingFaqFive" aria-expanded="false" aria-controls="pricingFaqFive">
                    5. How do payments work for international clients?
                  </button>
                </h2>
                <div id="pricingFaqFive" class="accordion-collapse collapse" data-bs-parent="#pricingFaqAccordion">
                  <div class="accordion-body">
                    International clients can pay via PayPal, Wise, or bank transfer. Payment is typically split — an upfront deposit to begin, with the remainder due at project completion or in milestones for larger builds.
                  </div>
                </div>
              </div>
